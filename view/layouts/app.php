...
<body>
    ...
    $hideTopBarRoutes = ['login', 'register', 'forgot-password', 'confirm-otp', 'reset-password', 'home', '', 'book', 'customer-dashboard', 'customer-bookings', 'driver-dashboard', 'create-booking', 'about-us', 'locations', 'inquire'];
